...
const props = defineProps({
    feeTypes: Object, // Paginated list of fee types
});

// A reactive computed property for flash messages
const flash = computed(() => usePage().props.flash || {});

// Inertia form to handle delete requests
const form = useForm({});
...
// Helper function to format currency (assuming 'paisa' is a subdivision of 'BDT')
const formatCurrency = (amountInPaisa) => {
    if (amountInPaisa === null || amountInPaisa === undefined) {
        return 'N/A';
    }
    // Convert paisa to BDT and format to two decimal places
